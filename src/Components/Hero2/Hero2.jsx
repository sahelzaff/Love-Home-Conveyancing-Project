        ...
        <div className='relative h-auto mb-44 '>
            <section className="relative h-[100vh] bg-center bg-cover bg-no-repeat brightness-110" id='mainrc' style={{ backgroundImage: `url(${assets.banner_rc})` }}>
                <div className="absolute inset-0 w-[43%] bg-white bg-opacity-0 flex flex-col items-start justify-center" id='banner_rc' data-aos='fade-right' data-aos-duration="1000">
                    ...
                    <p className='font-inter font-normal text-sm sm:text-base md:text-lg lg:text-xl w-full  text-white' id='text4'>Leave the hassle to me, and focus on what really matters to you. so you can chat directly with <br /> the qualified property lawyer.
                    </p>

                    <p className='font-inter font-normal w-full text-white' id='text5'><span className='text-[#f0532d] font-inter ' id='text7' >Mr Robin Carter</span><br />Principal Solicitor at Love Homes Conveyancing
                      <br />
                    ...
                    <div className='pt-3 sm:pt-5'>
                        <a href="" className='text-sm sm:text-base md:text-lg font-inter text-white font-medium hover:text-[#f0532d] cursor-pointer' id='text6'>My Stories</a>
                    </div>
