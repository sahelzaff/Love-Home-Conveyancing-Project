        ...
        <div className='h-auto flex flex-col pt-48 ' id='mainmainmainworkservicediv'>
            ...
            <div className='grid grid-cols-2 grid-rows-3 gap-10 w-full mx-auto ' id='workGrid'>
                <div className='flex flex-row gap-5 items-start justify-start ' data-aos='fade-up' data-aos-duration="1000" data-aos-delay="500" data-aos-once="true">
                    <div>
                    <div className="text-[#f0532d] text-4xl md:text-5xl lg:text-8xl font-[900]" id='serviceprocessworknumbers'>1</div>
                    </div>
                    <div className='flex flex-col items-start'  >
                        <h2 className='font-outfit text-3xl pt-6  text-[#f0532d] font-bold ' id='workHead'>Engagement</h2>
                        <div className='w-[8rem] h-[0.3rem] bg-[#f0532d] my-2  mb-5' id='horizontalline_sublines2'></div>
                ...
                <div className='flex flex-row gap-5 ' data-aos='fade-up' data-aos-duration="1000" data-aos-delay="500" data-aos-once="true">
                    <div>
                    <div className="text-[#f0532d] text-4xl md:text-5xl lg:text-8xl font-[900]" id='serviceprocessworknumbers'>2</div>
                    </div>
                    <div>
                        <h2 className='font-outfit text-3xl pt-6  text-[#f0532d] font-bold' id='workHead'>Consultation & Documentation</h2>
                        <div className='w-[8rem] h-[0.3rem] bg-[#f0532d] my-2 mb-5' id='horizontalline_sublines'></div>
                ...
                <div className='flex flex-row gap-5 ' data-aos='fade-up' data-aos-duration="1000" data-aos-delay="500" data-aos-once="true">
                    <div>
                    <div className="text-[#f0532d] text-4xl md:text-5xl lg:text-8xl font-[900]" id='serviceprocessworknumbers'>3</div>
                    </div>
                    <div>
                ...
                <div className='flex flex-row gap-5 ' data-aos='fade-up' data-aos-duration="1000" data-aos-delay="500" data-aos-once="true">
                    <div>
                    <div className="text-[#f0532d] text-4xl md:text-5xl lg:text-8xl font-[900]" id='serviceprocessworknumbers'>4</div>
                    </div>
                    <div>
                ...
                <div className='flex flex-row gap-5 ' data-aos='fade-up' data-aos-duration="1000" data-aos-delay="500" data-aos-once="true">
                    <div>
                    <div className="text-[#f0532d] text-4xl md:text-5xl lg:text-8xl font-[900]" id='serviceprocessworknumbers'>5</div>
                    </div>
                    <div>
                ...
                <div className='flex flex-row gap-5 ' data-aos='fade-up' data-aos-duration="1000" data-aos-delay="500" data-aos-once="true">
                    <div>
                    <div className="text-[#f0532d] text-4xl md:text-5xl lg:text-8xl font-[900]" id='serviceprocessworknumbers'>6</div>
                    </div>
                    <div>
