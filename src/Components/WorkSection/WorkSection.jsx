            ...
            <div className='grid grid-cols-2 grid-rows-3 gap-10 w-full mx-auto ' id='workGrid'>
                <div className='flex flex-row gap-2 '>
                    ...
                    <div className='flex flex-col items-start'>
                        <h2 className='font-outfit text-3xl pt-6  text-[#f0532d] font-bold '>Engagement</h2>
                        <div className='w-[8rem] h-[0.3rem] bg-[#f0532d] my-2  mb-5'></div>
                        <p className='font-poppins text-lg'> This initial step involves selecting and appointing a professional who is proficient in handling property transactions through digital platforms. The conveyancer or solicitor will explain the process, answer any initial questions, and begin gathering essential information. They will also provide a clear outline of the services they will offer, ensuring that the customer understands what to expect throughout the transaction. This engagement sets the foundation for a smooth and efficient conveyancing </p>
                    </div>
                </div>
                <div className='flex flex-row gap-2 '>
                    <div>
                ...
                <div className='flex flex-row gap-2 '>
                    ...
                    <div>
                        <h2 className='font-outfit text-3xl pt-6  text-[#f0532d] font-bold'>Property Checks</h2>
                        <div className='w-[8rem] h-[0.3rem] bg-[#f0532d] my-2 mb-5'></div>
                        <p className='font-poppins text-lg'> This step involves performing comprehensive searches to uncover any issues that could affect the property. We check for legal restrictions, planning permissions, environmental risks, and other factors. The conveyancer also verifies the property's title to ensure there are no hidden encumbrances or disputes. This thorough due diligence ensures the customer can proceed with confidence. </p>
                    </div>
                </div>
                <div className='flex flex-row gap-2 '>
                    <div>
                    ...
                    <div>
                        <h2 className='font-outfit text-3xl pt-6  text-[#f0532d] font-bold'>Financial Arrangements</h2>
                        <div className='w-[8rem] h-[0.3rem] bg-[#f0532d] my-2 mb-5'></div>
                        <p className='font-poppins text-lg'>This stage involves managing all financial details related to the property transaction. The conveyancer will coordinate with lenders, ensure funds are in place, and prepare for the final settlement. They will also calculate adjustments for rates and taxes and ensure all financial obligations are met. This meticulous preparation ensures a smooth and timely settlement process.</p>
                    </div>
                </div>
                <div className='flex flex-row gap-2 '>
                    <div>
