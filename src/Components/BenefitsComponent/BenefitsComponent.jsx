  ...
  return (
    <div className="bg-[#F4F4F4] p-8 h-auto pb-36 w-2/3" id="benefitMain" >
      ...
      <div className='flex flex-row justify-evenly items-center gap-6'id="cardDiv"> 
        {/* card-1 */}
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg  transition-height w-2/3 height" id='box-shadow' >
      <a href="#">
      ...
      <div className="p-5">
        ...
        <div className="relative overflow-hidden transition-all duration-300 ease-in-out" style={{ maxHeight: contentHeight }}>
          <p ref={contentRef} className="font-normal text-gray-700 dark:text-gray-400 font-poppins" id="cardText">
        ...
        <button 
          ...
          className="mt-3 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#f0532d] rounded-lg hover:bg-[#f0532dec] focus:ring-4 focus:outline-none cursor-pointer font-montserrat"
        >
