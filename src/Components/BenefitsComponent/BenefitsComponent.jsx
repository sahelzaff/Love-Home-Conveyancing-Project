...
const BenefitsComponent = () => {
  return (
    <div className="bg-[#f4f4f4]  h-auto pb-36 w-[75%]" id="benefitMain" >
      ...
      <div class='flex flex-row justify-evenly items-center gap-6' id="cardDiv">
        {/* card-1 */}
        <div id="card">
          <div id="first-content">
            <img class="rounded-t-lg rounded-xl w-2/6 icons" src={assets.Benefit1} alt="" />
            <h5 id="card-title">Seamless Digital Experience</h5>
          </div>
        ...
        <div id="card">
          <div id="first-content">
            ...
            <h5 id="card-title" >Stress Free Communication</h5>
          </div>
          <div id="second-content">
            <h5 id="card-title">Stress Free Communication</h5>
             <div className='w-24 sm:w-32 md:w-40 lg:w-44 h-[0.3rem] bg-[#f0532d] mb-3 sm:my-4 md:mb-5 rounded-e-md'></div>
        ...
        <div id="card">
          <div id="first-content">
            ...
            <h5 id="card-title">Trusted and Proven</h5>
          </div>
          <div id="second-content">
            <h5 id="card-title">Trusted and Proven</h5>
             <div className='w-24 sm:w-32 md:w-40 lg:w-44 h-[0.3rem] bg-[#f0532d] mb-3 sm:my-4 md:mb-5 rounded-e-md'></div>
