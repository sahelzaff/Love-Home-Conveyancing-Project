...
const BenefitsComponent = () => {
  const handleMouseEnter = (e) => {
    const img = e.currentTarget.querySelector('.second-content img');
    if (img) {
  ...
  return (
    <div className="bg-[#f4f4f4] h-auto pb-36 w-[75%]" id="benefitMain">
      ...
      <div className='flex flex-row justify-evenly items-center gap-6 mx-auto' id="cardDiv" data-aos='fade-up' data-aos-duration="1000" data-aos-once="true">
        {/* Card 1 */}
        <div className="card" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
          <div className="first-content hidden">
            ...
            < h3 className="card-title" id="card_title">Seamless Digital Experience</ h3>
          </div>
        ...
        <div className="card" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
          <div className="first-content hidden">
            ...
            <h2 className="card-title" id="card_title">Stress Free Communication</h2>
          </div>
          <div className="second-content">
        ...
        <div className="card" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
          <div className="first-content hidden">
            ...
            < h3 className="card-title" id="card_title">Trusted and Proven</ h3>
          </div>
          <div className="second-content">
