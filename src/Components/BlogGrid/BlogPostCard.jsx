...
const BlogPostCard = () => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 w-[86%] mx-auto py-32 bg-[#f4f4f4] group" id='blogpostcardmain' data-aos='fade-in' data-aos-duration="1000" data-aos-delay="200">
